...
@section('content')
    <form action="/jobs/{{$job->id}}" class="col-5 rounded shadow d-flex flex-column mx-auto p-5 mt-5" method="POST">
                @csrf
                @method('PUT')
                @if(isset($message))
                    <span class="alert alert-{{$insert ? 'success' : 'danger'}} text-center">{{$message}}</span>
                @endif
                <h3 class="text-center text-dark">Edit Job Update</h3>
                <div class="mt-3">
                    <label for="" class="form-label">Job Title</label>
                    <input type="text" name="job_title" class="form-control px-3 py-2 w-full" value={{ $job['job_title']}} placeholder="Job Title">
                </div>
                ...
                <div class="mt-3">
                    ...
                    <textarea  id="" cols="30" rows="2" name="job_description" class="form-control px-3 py-2 w-full" placeholder="Job Description">{{ $job['job_desc']}}</textarea>
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="job_requirement" class="form-control px-3 py-2 w-full" placeholder="Job Requirement" value={{ $job['job_req']}}>
                </div>
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="job_location" class="form-control px-3 py-2 w-full" placeholder="Job Location" value={{ $job['job_location']}}>
                </div>
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="link" class="form-control px-3 py-2 w-full" placeholder="Application Link" value={{$job['link']}}>
                </div>
                ...
                <button class="btn btn-primary w-100 mt-3 p-2">Edit</button>
    </form>
@endsection